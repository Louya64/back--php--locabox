                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?php echo $_SESSION['user']['nom'] . ' ' . $_SESSION['user']['prenom']; ?></span>
                                <img class="img-profile rounded-circle"
                                    src="<?= URL_ADMIN ?>img/undraw_profile.svg">
                            </a>
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item" href="<?= URL_ADMIN ?>logout.php" data-toggle="modal" data-target="#logoutModal">
