...
<h1 class="text-center">Ajouter un box</h1>
    ...
    <table class="table">
        ...
        <tbody>
            <tr>
                ...
                <td><input type="number" class="form-control" name="prix" id="prix" required step="0.01"></td>
                <td><input type="number" class="form-control" name="disponibilite" id="disponibilite" value="0" required></td>
